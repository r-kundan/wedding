...
export function BackgroundGradientDemo({ imgSrc, name, description }) {
  return (
    <div>
      <BackgroundGradient className="rounded-22px max-w-sm p-3 m-2 bg-white dark:bg-zinc-900">
        <img
          src={imgSrc}
          alt={name}
          height="400"
        ...
        />
        <p className="text-4xl text-black mt-4 flex justify-center mb-2 dark:text-neutral-200" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300"
